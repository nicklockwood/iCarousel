...
- (void)depthSortViews
{
    ...
    for (UIView *view in [[itemViews allValues] sortedArrayUsingComparator:^NSComparisonResult(id obj1, id obj2) {
            ...
            if (difference == 0.0f)
            {
                CATransform3D t3 = [self currentView].superview.layer.transform;
